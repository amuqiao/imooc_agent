...
def test_ollama_chat():
    """测试使用 langchain 调用本地 ollama 模型进行对话"""
    # 初始化 ChatOllama，指定模型
    llm = ChatOllama(
        model="gemma3:1b",
        # 可以根据需要调整温度等参数
    ...
    # 测试多轮对话
    follow_up_question = HumanMessage(
        content="人工智能有哪些常见的应用？"
    )
    ...
    return response.content, follow_up_response.content
